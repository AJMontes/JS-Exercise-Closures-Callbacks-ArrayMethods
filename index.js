 ...
 * It takes two arguments:
 * @param list an array with elements of any type.x
 * @param callback function that takes a number as its argument.x
 * @returns the result of invoking `callback` passing the LENGTH of `list`.x
 * 
...
function processSum(numberList, callback) {
  let totalSum = numberList.reduce(function(accumulator, numberList) {
